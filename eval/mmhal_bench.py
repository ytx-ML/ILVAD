...
if __name__ == '__main__':
    ...
    parser.add_argument('--response', type=str, default='', help='response file containing images, questions, and model responses')
    parser.add_argument('--evaluation', type=str, default='', help='GPT-4 evaluation results to be saved')
    ...
    if args.evaluation is not None:
        serializable_responses = [r.model_dump() for r in responses]
